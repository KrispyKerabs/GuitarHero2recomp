...
// Compatibility for builtin functions not in older GCC
  ...
  #define __builtin_rotateleft32(x, n) ((n) == 0 ? (x) : (((x) << (n)) | ((x) >> (32 - (n)))))
#endif

#if !__has_builtin(__builtin_rotateleft64)
  #define __builtin_rotateleft64(x, n) ((n) == 0 ? (x) : (((x) << (n)) | ((x) >> (64 - (n)))))
#endif

// __rdtsc support for non-MSVC compilers
#if !defined(_MSC_VER) && !defined(__rdtsc)
  #include <x86intrin.h>
#endif

// __builtin_debugtrap support
